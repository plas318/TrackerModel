...
trackBtn.addEventListener("click", (event) => {
    ...
    let imgPath = `C:/Users/restaart/jscripts/Web1/styles/images/${startingPoint.value}-${health.value}-${difficulty.value}-${tourVisit.value}/${startingPoint.value}-${health.value}-${difficulty.value}-${tourVisit.value}.png
    `;
    ...
    const showPic = () => {
        ...
        resultImg.addEventListener('click', (e) => {
            ...
            if (resultImg.classList.contains('switch')) {
                resultImg.setAttribute('src', `C:/Users/restaart/jscripts/Web1/styles/images/${startingPoint.value}-${health.value}-${difficulty.value}-${tourVisit.value}/o${startingPoint.value}-${health.value}-${difficulty.value}-${tourVisit.value}.jpg`);
